...
- `client/src/components/app-layout.tsx` — Responsive layout: desktop top nav bar (dark, horizontal, with user dropdown) + mobile bottom tab bar (5 tabs) with hamburger slide-out menu for extras (Reports, Personnel, user info, logout)
